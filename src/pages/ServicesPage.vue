        ...
        >
          <div class="service-image">
            <svg viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient :id="'svcGrad' + index" x1="0" y1="0" x2="400" y2="300">
              ...
              <rect width="400" height="300" :fill="'url(#svcGrad' + index + ')'"/>
              <g :style="{ color: 'var(--color-primary)' }">
                <rect x="60" y="50" width="280" height="40" rx="8" fill="currentColor" opacity="0.1"/>
